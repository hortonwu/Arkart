...
const int ULTRASONIC_FRONT = 14;
const int ULTRASONIC_BACK = 16;

// Distance at which automatic braking starts
const int DIST_BRAKE_FORWARD = 35; // cm
const int DIST_BRAKE_REVERSE = 35; // cm
...
void setup() 
{
  ...
  //Input
  attachInterrupt(0, channel1, CHANGE); //Throttle
  attachInterrupt(1, channel2, CHANGE); //Steering
  delay(200);
